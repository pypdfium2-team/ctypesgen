...
class CommonHeaderTest(unittest.TestCase):
    ...
    @classmethod
    def tearDownClass(cls):
        # cleanup_common() is not currently working on MS Windows. The reason is
        # that it tries to delete "common.dll" while it is still loaded by ctypes.
        ...
        # In addition, we import the module generated by ctypesgen, which again means
        # the dll is loaded to memory.
